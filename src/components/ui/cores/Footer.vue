<template>
  <footer class="w-[90%] bg-[#5208b6] mx-auto my-10 rounded-2xl p-10">
    <div
      class="flex flex-col-reverse justify-between gap-5 lg:flex-row lg:gap-0"
    >
      <div class="flex flex-col items-center gap-16">
        <h3 class="font-bold text-2xl text-white">BookMates</h3>
      ...
      <div class="flex flex-col justify-between gap-5 lg:w-1/3">
        <form>
          <div class="flex w-[80%] ml-12">
            ...
            />
            <button
              class="w-[20%] p-2 bg-purple-700 text-white rounded-r-full border-none cursor-pointer hover:bg-purple-600"
            >
              Go
            </button>
          </div>
        ...
        <div class="text-white text-center lg:block">
          Copyright &copy; BookMates 2024, All Rights Reserved
        </div>
      </div>
    </div>
  </footer>
